...
## 📋 Adaptação da Arquitetura (AWS vs. Railways)
...
| **ECR** (Registry) | **Docker Hub** | No lugar do Elastic Container Registry, utilizamos o Docker Hub. Nossos workflows de CI/CD autenticam e enviam as imagens tagueadas como `staging` e `production` para este registro privado. |
